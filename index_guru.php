...
<body>
        <header>
            <div class="jumbotron">
                ...
                <p class="head">SMK NEGERI 1 JAMBI</p>
            </div>
...
<main>
    ...
    <aside>
        <article class="profile">
            <header>
                <h2>SMK NEGERI 1 JAMBI</h2>
                <figure>
                    <img src="css1/SMK NEGERI 1 JAMBI.png">
                </figure>
            </header>
            <section>
                ...
                <table>
                    <tr>
                        <th>Jalan</th>
                        <td>Jl. Jend. A. Thalib, Simpang IV Sipin, Kec. Telanaipura, Kota Jambi, Provinsi Jambi.</td>
                    </tr>
                </table>
            </section>
        </article>
